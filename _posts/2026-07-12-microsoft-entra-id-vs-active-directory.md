...
author: pankaj
description: "Treating Entra ID as Active Directory in the cloud causes the most confusion in the admin center. Same goal as AD, completely different assumptions though."
image:
  path: /assets/img/og-default.png
  alt: "Microsoft Entra ID vs Active Directory: Same Goal, Different Assumptions"
---
